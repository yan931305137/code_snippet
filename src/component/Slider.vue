  ...
  <div>
    <slider ref="slider" :options="option" style="width: 1120px; margin: 10px auto; height: 500px">
      <slideritem v-for="(card, index) in cards" v-if="dataNotNull" :key="index" class="slide-item">
        <i class="slideButton el-icon-arrow-left" style="margin: 0 -80px 0 80px;" @click="slidePre"></i>
        ...
        <i class="slideButton el-icon-arrow-right" style="margin: 0 80px 0 -80px" @click="slideNext"></i>
      </slideritem>
